...
export async function playlistRename(id: number, name: string): Promise<PlaylistNode> {
...
export async function playlistDeleteImpact(id: number): Promise<PlaylistDeleteImpact> {
...
export async function playlistAddTracks(
  ...
  return invoke<number[]>("playlist_add_tracks", { playlistId, trackIds, position });
}
...
export async function tagCreateAxis(name: string, selection: TagSelection): Promise<TagAxis> {
...
export async function tagAssign(trackIds: number[], tagIds: number[]): Promise<void> {
  return invoke("tag_assign", { trackIds, tagIds });
}

export async function tagUnassign(trackIds: number[], tagIds: number[]): Promise<number> {
